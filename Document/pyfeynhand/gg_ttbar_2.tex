...
\begin{tikzpicture}
  ...
  \begin{feynhand}
    ...
    \propagator [fermion, IndianRed] (gt1) to (t1);
    \propagator [fermion, ForestGreen] (gt2) to [edge label=\Pqt, color=ForestGreen] (gt1);
    \propagator [fermion, IndianRed] (t2) to (gt2);
  \end{feynhand}
\end{tikzpicture}
\end{document}
