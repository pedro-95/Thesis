...
\addbibresource{../Thesis/thesis_refs.bib}
...
\bibliography{../Thesis/thesis_refs,%
...
\Option{biber} seems to work well with \TeXLive 2012 and later and hence is the default.
...
\begin{bashlisting}
bibtool -x Thesis.aux -o refs.bib
\end{bashlisting}
...
Do not forget to change \texttt{Thesis.tex} to use
