...
The atomic beam of erbium produced by the \ac{dfc} oven presents two main problems, which must be fixed before being able to trap the atoms in an atomic ensemble and form a \ac{bec}. These problems are the collimation and speed of the erbium beam. 
