...
Due to this, we consider an atom with a ground state $\ket{g}$, an excited state $\ket{e}$ and an energy difference between both states of $\Delta E = \hbar \omega_0$, where $\omega_0$ represents the atomic resonance frequency. The atom at rest can absorb a photon with resonant frequency $\omega_0$, transferring its energy $\hbar \omega_0$ and momentum $\abs{\vec{p}}$ into the atom. Where $\abs{\vec{p}} = \hbar k$ with $k$ representing the wave number of atoms. As a result, 
