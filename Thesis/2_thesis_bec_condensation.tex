...
\begin{figure}[!htbp]\centering
	...
	\caption[Scheme of the experimental set up]{Scheme of the experimental setup. It is divided in three optical tables represented by the gray areas.}\label{fig:table_set_up}
\end{figure}
