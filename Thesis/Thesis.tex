...
\usepackage[backend=biber, backref=false, doi=false, style=phys, biblabel=brackets, sorting=none, block=ragged, maxbibnames=5, firstinits]{biblatex}
...
%\include{thesis_acknowledge} % <----------------------------------------------------------UNCOMMENT ACKNOWLEDGEMENTS!
...
\include{1_thesis_intro}
\include{2_thesis_bec_condensation}
\include{3_thesis_bec_diffraction}
\include{4_thesis_raman_manipulation}
\include{5_thesis_results}
\include{6_outlook}
...
%\include{thesis_appendix} % <----------------------------------------------------------UNCOMMENT APPENDIX!
% \printbibliography[heading=subbibliography]
