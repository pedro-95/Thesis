...
\newcommand{\thesistitle}{Bragg Scattering with ultracold Erbium atoms}
...
\DeclareAcronym{aom}{short=AOM,long=acousto-optical modulator}
...
\include{3_thesis_bragg_scattering}
